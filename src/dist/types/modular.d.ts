...
export type ModuleLifecycleEvent = 'module.registered' | 'module.unregistered' | 'module.started' | 'module.stopped' | 'module.error' | 'module.heartbeat' | 'module.communication';
