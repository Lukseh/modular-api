...
class ExampleCMS {
    constructor() {
        ...
        this.modular = new cms_integration_1.ModularCMS();
        this.setupCMS();
    }
    setupCMS() {
    ...
    setupModularEventHandlers() {
        ...
        this.modular.onModuleEvent('module.unregistered', (data) => {
    ...
    async startWithIntegratedAPI(port = 3000) {
    ...
    async startWithSeparateAPI(cmsPort = 3000, apiPort = 7474) {
...
function setupGracefulShutdown(cms) {
...
//# sourceMappingURL=cms-example.js.map